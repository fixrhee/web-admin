              ...
              <div class="col-md-12 col-sm-12 col-xs-12">
                <div class="x_panel">
                  <div class="x_title">
                   ...
                   <div class="x_content">
        			 <br />
                    <form id="webserviceform" data-parsley-validate action="/admin/createWebserviceForm" method="POST" modelAttribute="createwebservice" class="form-horizontal form-label-left">
                      ...
                      <div class="form-group">
                        ...
                        <div class="col-md-6 col-sm-6 col-xs-12">
                          <input type="text" id="hash" name="hash" required="required" class="form-control col-md-7 col-xs-12">
                        </div>
                      </div>
                      <div class="form-group">
                      ...
                      <div class="form-group">
                          <label class="control-label col-md-3 col-sm-3 col-xs-12">Enable PIN </label>
                        </label>
                        <div class="col-md-6 col-sm-6 col-xs-12">
                           <div class="">
                       		 <label>

              ...
              <div class="col-md-12 col-sm-12 col-xs-12">
                <div class="x_panel">
                  <div class="x_title">
                   ...
                   <div class="x_content">
        			 <br />
                    <form id="trfTypeform" data-parsley-validate action="/admin/createTransferTypeForm" method="POST" modelAttribute="createTransferTypeModel" class="form-horizontal form-label-left">
                     ...
                     <div class="form-group">
                        ...
                        <div class="col-md-6 col-sm-6 col-xs-12">
                          <input type="text" id="otpThreshold" name="otpThreshold" required="required" value="0" class="form-control col-md-7 col-xs-12">
                        </div>
                      </div>
                       <div class="form-group">
                        ...
                        <div class="col-md-6 col-sm-6 col-xs-12">
                          <input type="text" id="maxCount" name="maxCount" required="required" value="0" class="form-control col-md-7 col-xs-12">
                        </div>
                      </div>

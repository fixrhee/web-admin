          ...
          <div class="">
            ...
            <div class="row">
              <div class="col-md-12 col-sm-12 col-xs-12">
                <div class="x_panel">
                  <div class="x_title">
                    <h2>Create Transfer Notification</h2>
                   ...
                   <div class="x_content">
        			 <br />
                    <form id="transferNotificationForm" data-parsley-validate action="/admin/createTransferNotificationForm" method="POST" modelAttribute="createTransferNotificationModel" class="form-horizontal form-label-left">
				      <div class="form-group">
		                ...
		                <div class="col-md-6 col-sm-6 col-xs-12">
                          <input type="text" id="notificationType" name="notificationType" required="required" class="form-control col-md-7 col-xs-12">
                        </div>
                      </div>

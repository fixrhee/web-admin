                  ...
                  <div class="x_content">
                    ...
                    <form id="transfermemberform" data-parsley-validate action="/admin/transferMemberInquiry" method="POST" modelAttribute="transfermember" class="form-horizontal form-label-left">
                      ...
                      <div class="form-group">
                       ...
                       <div class="form-group">
                        <label class="control-label col-md-3 col-sm-3 col-xs-12" for="toMember">To Member :</span>
                        </label>
                        <div class="col-md-6 col-sm-6 col-xs-12">
                          <input type="text" id="toMember" name="toMember" required="required" class="form-control col-md-7 col-xs-12">
                          </div>
                      </div>

              ...
              <div class="col-md-12 col-sm-12 col-xs-12">
                <div class="x_panel">
                  <div class="x_title">
                   ...
                   <div class="x_content">
        			 <br />
                    <form id="accountform" data-parsley-validate action="/admin/createAccountForm" method="POST" modelAttribute="createAccountModel" class="form-horizontal form-label-left">
		                ...
		                <div class="col-md-6 col-sm-6 col-xs-12">
		                  <select name="currencyName" class="select2_single form-control" tabindex="-1">
		                        ...
		                        <c:forEach var="listCurrency" items="${listCurrency}">
									<option name="currencyName" id="currencyName" value="${listCurrency}">${listCurrency}</option>
								</c:forEach>
		                   </select>
		                </div>
		              </div>

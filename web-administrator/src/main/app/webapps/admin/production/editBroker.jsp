              ...
              <div class="col-md-12 col-sm-12 col-xs-12">
                <div class="x_panel">
                  <div class="x_title">
                   ...
                   <div class="x_content">
        			 <br />
                    <form id="feeForm" data-parsley-validate action="/admin/editBrokerForm" method="POST" modelAttribute="createBrokerModel" class="form-horizontal form-label-left">
                       ...
                       <div class="form-group">
                        ...
                        <div class="col-md-6 col-sm-6 col-xs-12">
                          <input type="text" id="toMember" name="toMember" value="${toMember}" class="form-control col-md-7 col-xs-12">
                        </div>
                      </div>
		             ...
		             <hr />
		              ...
		              <div class="form-group">
                        ...
                        <div class="col-md-6 col-sm-6 col-xs-12">
                           <div class="">
                       		 <label>
                       		   <c:if test="${deductAllFee}">
                           		 <input type="checkbox" id="deductAllFee" name="deductAllFee" class="js-switch" value="1" checked /> True
                                </c:if>
                        		  <c:if test="${deductAllFee == false}">
                        		     <input type="checkbox" id="deductAllFee" name="deductAllFee" class="js-switch" value="1" /> True
                              </c:if>
                            </label>
                            </div>
                    		 </div>
                     ...
                     <div id="amountDiv" class="form-group">
                        ...
                        <div class="col-md-6 col-sm-6 col-xs-12">
                          <input type="text" id="fixedAmount" name="fixedAmount" value="${fixedAmount}" required="required" value="0" class="form-control col-md-7 col-xs-12">
                        </div>
                      </div>
                       ...
                       <div id="percentageDiv" class="form-group">
                        ...
                        <div class="col-md-6 col-sm-6 col-xs-12">
                          <input type="text" id="percentage" name="percentage" value="${percentage}" required="required" value="0" class="form-control col-md-7 col-xs-12">
                        </div>
                      </div>
